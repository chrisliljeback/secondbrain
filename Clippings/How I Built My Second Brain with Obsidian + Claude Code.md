...
source: "https://medium.com/@evgeni.n.rusev/how-i-built-my-second-brain-with-obsidian-claude-code-9fb54b7665ca"
author:
  - "[[Evgeni Rusev]]"
published: 2026-04-28
created: 2026-07-06
description: "A practical guide to building an AI-native personal knowledge base that reads, structures, and connects ideas for you."
tags:
  - "clippings"
---
...
For almost a decade, I’ve been building a personal knowledge base in Notion. I like to read broadly — books and articles across AI, decision-making, economics, history and other. I take notes, tag them, cross-reference them, draw parallels between disciplines, and distill everything into practical mental models I can apply at work and in life.
...
Obsidian graph view is showing interconnected concepts. Every node is a standalone markdown file. Every line is a `[[wikilinks]] ` connecting two ideas. The book nodes sit near the center, radiating outward to 86 mental model pages Claude created across eight domains — physics, chemistry, biology, economics, mathematics, systems thinking and general thinking. You can see how concepts from different chapters — and even different sources — cluster together naturally.
...
## Get Evgeni Rusev’s stories in your inbox
...
Example Obsidian Copilot use-case
...
*The full schema is available on* [*GitHub*](https://github.com/evgenirusev/obsidian-second-brain/blob/master/CLAUDE.md)*. If you build your own version, I’d love to hear how it goes.*